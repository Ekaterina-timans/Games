    ...
    for (let i = 1040; i < 1072; i++) {
        ...
        button.addEventListener("click", () => {
            ...
            if (charArray.includes(button.innerText)) {
                charArray.forEach((char, index) => {
                    ...
                    if (char === button.innerText) {
                        ...
                        if (winCount == charArray.length) {
                            resultText.innerHTML = `<h2 class='win-msg'>Вы выиграли!</h2><p>Слово было <span>${chosenWord}</span></p>`;
                            saveGameResult("win");
                            blocker();
                        }
                    }
                ...
                if (count == 6) {
                    resultText.innerHTML = `<h2 class='lose-msg'>Вы проиграли</h2><p>Слово было <span>${chosenWord}</span></p>`;
                    saveGameResult("lose");
                    blocker();
                }
            }
